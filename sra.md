...
- [Github Link](https://github.com/SRA-VJTI/sra-board-hardware-design)
...
<p align="center">
  <img width="460" height="300" src="/images/boards_compare.png">
</p>
...
- ### **Motor Driver Modes**
    - The new edition has 2x TB6612FNG motor drivers which allow a maximum of 4 motors to be controlled. This motor driver is characterized by its operation in two modes - **Normal mode** and **Parallel mode**:   
        ...
        <br />
        <p align="center">
        <img width="460" height="300" src="images/normal_mode.jpeg">
        </p>
        ...
        <br />
        <p align="center">
        <img width="460" height="300" src="images/parallel_mode.jpeg">
        </p>
...
- ### **The Simultaneous Power Supply Issue**
    ...
    - #### Solution
        ...
        <p align="center">
            <img width="460" height="300" src="images/diode_vin.png">
        </p>
